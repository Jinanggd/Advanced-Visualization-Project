...
bool Shader::load( const std::string& vsf, const std::string& psf )
{
	...
	vs_filename = addCurrentPath( vsf );
	ps_filename = addCurrentPath( psf );
...
GLint Shader::getLocation( const std::string& varname )
{
	if( varname.size() == 0 )
		return 0;

	GLint loc = 0;
	loctable& locs = locations;

	loctable::iterator cur = locs.find( varname );

	if( cur == locs.end() ) //not found in the locations table
	{
		loc = glGetUniformLocation( program, varname.c_str() );
		if( loc == -1 )
		{
			return -1;
		}
...
int Shader::getAttribLocation( const std::string& varname )
{
	int loc = glGetAttribLocation( program, varname.c_str() );
	if( loc == -1 )
	{
		return loc;
	}
...
int Shader::getUniformLocation( const std::string& varname )
{
...
void Shader::setTexture( const std::string& varname, const Texture& tex )
{
	setTexture( varname, tex.m_GLTexture );
}

void Shader::setTexture( const std::string& varname, unsigned int tex )
{
...
void Shader::setUniform1( const std::string& varname, int input1 )
{
...
void Shader::setUniform2( const std::string& varname, int input1, int input2 )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform3( const std::string& varname, int input1, int input2, int input3 )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform4( const std::string& varname, const int input1, const int input2, const int input3, const int input4 )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform1Array( const std::string& varname, const int* input, const int count )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform2Array( const std::string& varname, const int* input, const int count )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform3Array( const std::string& varname, const int* input, const int count )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform4Array( const std::string& varname, const int* input, const int count )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform1( const std::string& varname, const float input1 )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform2( const std::string& varname, const float input1, const float input2 )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform3( const std::string& varname, const float input1, const float input2, const float input3 )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform4( const std::string& varname, const float input1, const float input2, const float input3, const float input4 )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform1Array( const std::string& varname, const float* input, const int count )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform2Array( const std::string& varname, const float* input, const int count )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform3Array( const std::string& varname, const float* input, const int count )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setUniform4Array( const std::string& varname, const float* input, const int count )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setMatrix44( const std::string& varname, const float* m )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
...
void Shader::setMatrix44( const std::string& varname, const Matrix44 &m )
{
	GLint loc = getLocation( varname );
	CHECK_SHADER_VAR( loc, varname );
